...
spinlist = [rect0image, ro00image, ro01image, ro02image, ro03image, ro04image, ro05image, ro06image, ro07image
, ro08image, ro09image, ro10image, rect1image]
score = 0
...
def create_obstacle():
      ...
      canvas.after(500-score, create_obstacle)
create_obstacle()
